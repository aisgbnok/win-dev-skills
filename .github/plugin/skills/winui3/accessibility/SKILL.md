---
name: accessibility
description: 'Accessibility requirements for WinUI 3 apps — AutomationProperties, keyboard navigation, screen readers, and contrast. Use when adding or modifying interactive controls.'
---
